const CACHE_NAME='puy-planner-v1.4.4';
const CORE=['./','./index.html','./styles.css','./data.js','./solver.js','./app.js','./app-core.js','./official-source.js','./manifest.webmanifest','./icon.svg'];
